"""
Django settings for free_space project.
...
SECRET_KEY = '2srt7hr2r%0jjdy5f$c1$xhz#3v)d69&527idjh^38_x5__sxc'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = [
    #'www.myyfree_space.pythonanywhere.com',
    #'myyfree_space.pythonanywhere.com',
    'localhost',
    '127.0.0.1',
    '[::1]',
    'testserver',
